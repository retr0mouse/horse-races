...
@Configuration
@EnableWebSecurity   // tells Spring to find and apply this class to the global Web Security
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Override
    protected void configure(HttpSecurity http) throws Exception {  // tells Spring how to deal with CORS and CSRF
